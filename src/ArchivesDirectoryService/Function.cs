...
public class Function
{
    ...
    public static async Task<APIGatewayHttpApiV2ProxyResponse> FunctionHandler(APIGatewayHttpApiV2ProxyRequest input, ILambdaContext context)
    {
        ...
        {
            case "GET":
                return await GetArchivesAsync(input, userId!);
            case "POST":
                return await CreateFolderAsync(input, userId);
    ...
    private static async Task<APIGatewayHttpApiV2ProxyResponse> GetArchivesAsync(APIGatewayHttpApiV2ProxyRequest input, string userId)
    {
    ...
    private static async Task<APIGatewayHttpApiV2ProxyResponse> CreateFolderAsync(APIGatewayHttpApiV2ProxyRequest input, string userId)
    {
